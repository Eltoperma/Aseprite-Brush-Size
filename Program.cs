...
namespace Projekt_Pepeja
{
    class Program
    {
            
            static bool isrunning = true;
            static System.Drawing.Point newpos = new System.Drawing.Point();
            static System.Drawing.Point oldpos = new System.Drawing.Point(); 
            //Enables Windows api inputs
            [STAThread]
        ...
        //Importing GetCursorPos
        [DllImport("user32.dll")]
        static extern bool GetCursorPos(ref System.Drawing.Point lpPoint);
        //Method Checks if the Mouse was moved left or right and sends keys accordingly
        static void HandleInput()
        {
            ...
            else if (Keyboard.IsKeyDown(Key.LeftAlt) && Keyboard.IsKeyDown(Key.LeftCtrl) && Keyboard.IsKeyDown(Key.Back) )
            {
                isrunning = false;
            }
        ...
        //Importing lots of win api stuff to make sending keys work
        [DllImport("user32.dll")]
